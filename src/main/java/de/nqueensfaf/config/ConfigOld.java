...
public class ConfigOld {
    ...
    @JsonCreator
    public ConfigOld(@JsonProperty(value = "type", required = true) String type,
    ...
    public static ConfigOld getDefaultConfig() {
	final ConfigOld c = new ConfigOld();
	c.setType("CPU");
    ...
    public static ConfigOld from(File configFile) throws StreamReadException, DatabindException, IOException {
	ObjectMapper mapper = new ObjectMapper();
	ConfigOld config = mapper.readValue(configFile, ConfigOld.class);
	config.validate();
	return config;
    }
